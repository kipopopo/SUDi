 ...
 * @returns {React.ReactElement} The SVG logo icon.
 */
export const LogoIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2L2 7L12 12L22 7L12 2Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-brand-accent"/>
    <path d="M2 17L12 22L22 17" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-brand-accent-purple"/>
    <path d="M2 12L12 17L22 12" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-brand-accent/50"/>
  </svg>
);

/**
 * Renders a dashboard icon, typically used for navigation.
 * @returns {React.ReactElement} The SVG dashboard icon.
 */
...
/**
 * Renders a participants icon, representing a group of users.
 * @returns {React.ReactElement} The SVG participants icon.
 */
export const ParticipantsIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
);

/**
 * Renders a departments icon, representing an organization or building.
 * @returns {React.ReactElement} The SVG departments icon.
 */
export const DepartmentsIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
);

/**
 * Renders a templates icon, representing a document or email template.
 * @returns {React.ReactElement} The SVG templates icon.
 */
export const TemplatesIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
...
/**
 * Renders an email blast icon, represented by a paper plane.
 * @returns {React.ReactElement} The SVG blast icon.
 */
export const BlastIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
...
/**
 * Renders a history icon, represented by a clock.
 * @returns {React.ReactElement} The SVG history icon.
 */
...
/**
 * Renders an edit icon, represented by a pencil.
 * @returns {React.ReactElement} The SVG edit icon.
 */
...
/**
 * Renders a delete icon, represented by a trash can.
 * @returns {React.ReactElement} The SVG delete icon.
 */
...
/**
 * Renders a plus icon, used for 'add' or 'create' actions.
 * @returns {React.ReactElement} The SVG plus icon.
 */
...
/**
 * Renders an AI icon, represented by a lightbulb/brain symbol.
 * @returns {React.ReactElement} The SVG AI icon.
 */
 ...
 * @returns {React.ReactElement} The SVG loading icon.
 */
export const LoadingIcon: React.FC<IconProps> = ({ className = "animate-spin h-5 w-5 text-current" }) => (
...
/**
 * Renders a left-align icon for text formatting.
 * @returns {React.ReactElement} The SVG left-align icon.
 */
export const AlignLeftIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 10h10M4 14h16M4 18h10" /></svg>
);

/**
 * Renders a center-align icon for text formatting.
 * @returns {React.ReactElement} The SVG center-align icon.
 */
export const AlignCenterIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M7 10h10M4 14h16M7 18h10" /></svg>
);

/**
 * Renders a right-align icon for text formatting.
 * @returns {React.ReactElement} The SVG right-align icon.
 */
export const AlignRightIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M10 10h10M4 14h16M10 18h10" /></svg>
);

/**
 * Renders an image icon, used for inserting images.
 * @returns {React.ReactElement} The SVG image icon.
 */
 ...
 * @returns {React.ReactElement} The SVG upload icon.
 */
...
/**
 * Renders a help icon, represented by a question mark.
 * @returns {React.ReactElement} The SVG help icon.
 */
...
/**
 * Renders a sun icon, used for the light mode theme toggle.
 * @returns {React.ReactElement} The SVG sun icon.
 */
...
/**
 * Renders a moon icon, used for the dark mode theme toggle.
 * @returns {React.ReactElement} The SVG moon icon.
 */
...
/**
 * Renders a user icon, used as a default avatar.
 * @returns {React.ReactElement} The SVG user icon.
 */
...
/**
 * Renders a duplicate/copy icon.
 * @returns {React.ReactElement} The SVG duplicate icon.
 */
export const DuplicateIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 4h8a2 2 0 002-2V8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" /></svg>
);

/**
 * Renders a folder icon, for categorization.
 * @returns {React.ReactElement} The SVG folder icon.
 */
...
/**
 * Renders an upward chevron, used for ascending sort indication.
 * @returns {React.ReactElement} The SVG sort-up icon.
 */
...
/**
 * Renders a downward chevron, used for descending sort indication.
 * @returns {React.ReactElement} The SVG sort-down icon.
 */
 ...
 * @returns {React.ReactElement} The SVG logout icon.
 */
 ...
 * @returns {React.ReactElement} The SVG Google icon.
 */
...
export const LinkIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" /></svg>
);
export const ListUnorderedIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 12h16M4 18h16" /><circle cx="2" cy="6" r="1" fill="currentColor" strokeWidth="0"/><circle cx="2" cy="12" r="1" fill="currentColor" strokeWidth="0"/><circle cx="2" cy="18" r="1" fill="currentColor" strokeWidth="0"/></svg>
);
...
export const QuoteIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z" /></svg>
);
export const HorizontalRuleIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 12h16" /></svg>
);
...
export const SparklesIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 21l-3-3m0 0l3-3m-3 3h12" />
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 3l3 3m0 0l-3 3m3-3H6" />
 ...
 * @returns {React.ReactElement} The SVG menu icon.
 */
 ...
 * @returns {React.ReactElement} The SVG close icon.
 */
...
/**
 * Renders a checkmark in a circle.
 * @returns {React.ReactElement} The SVG check-circle icon.
 */
...
/**
 * Renders an X in a circle.
 * @returns {React.ReactElement} The SVG fail-circle icon.
 */
...
export const CursorClickIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
...
export const UserRemoveIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7a4 4 0 11-8 0 4 4 0 018 0zM9 14a7 7 0 00-7 7h14a7 7 0 00-7-7zm6-4h6m-3-3v6"></path></svg>
);

export const MailOpenIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 19v-8.93a2 2 0 01.89-1.664l7-4.666a2 2 0 012.22 0l7 4.666A2 2 0 0121 10.07V19M3 19a2 2 0 002 2h14a2 2 0 002-2M3 19l6.75-4.5M21 19l-6.75-4.5M12 12l-7.5 5M12 12l7.5 5"></path></svg>
);
...
export const CrownIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 18v-5a2 2 0 012-2h10a2 2 0 012 2v5M4 21h16M12 3l3 4H9l3-4z"></path></svg>
);
