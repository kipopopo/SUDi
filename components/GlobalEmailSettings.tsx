...
const GlobalEmailSettings: React.FC = () => {
  ...
  return (
    <div className="animate-fade-in-fast">
      <h2 className="text-xl font-bold font-title mb-6">Global Email Settings</h2>
      <form onSubmit={handleSave} className="space-y-6">
        <div>
          <label htmlFor="globalHeader" className="block text-sm font-medium text-light-text-secondary dark:text-brand-text-secondary mb-1">Global Header (HTML)</label>
          <textarea
            id="globalHeader"
            rows={6}
            value={globalHeader}
            ...
            placeholder="<!-- HTML for your email header, e.g., logo, company name -->"
          />
        </div>
        <div>
          <label htmlFor="globalFooter" className="block text-sm font-medium text-light-text-secondary dark:text-brand-text-secondary mb-1">Global Footer (HTML)</label>
          <textarea
            id="globalFooter"
            rows={6}
            value={globalFooter}
            ...
            className="w-full bg-light-bg dark:bg-brand-light/50 p-2.5 rounded-md border border-light-border dark:border-brand-light focus:outline-none focus:ring-2 focus:ring-brand-accent-purple dark:focus:ring-brand-accent font-mono text-sm"
            placeholder="<!-- HTML for your email footer, e.g., unsubscribe link, address -->"
          />
        </div>
